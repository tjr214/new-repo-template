...
- `src/new_repo_template/snapshot_assets/templates/` is the canonical source-of-truth for bundled template content; repo-root symlink aliases remain in place for compatibility with the existing manifest-driven maintainer workflow.
