...
- Planning history now includes the archived root plan at `docs/archive/plans/PLAN_2026-03-15_12-30-32_PM.md`; feature `4.0` is complete, and the older paired `PLAN.md` / `PROGRESS.md` archive remains at `docs/archive/plans/PLAN_2026-03-08_07-49-04_PM.md` and `docs/archive/plans/PROGRESS_2026-03-08_07-49-04_PM.md`.
...
- The next implementation slice is feature `5.0` for `nurt sync template-assets`: finish the native sync path and remove the remaining legacy updater after manual review.
